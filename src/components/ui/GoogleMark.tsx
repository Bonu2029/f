          ...
          <svg key={i} width={size} height={size} viewBox="0 0 20 20">
            <defs>
              <linearGradient id={`star-${i}-${size}`}>
                <stop offset={`${fill * 100}%`} stopColor="#B87A4E" />
                <stop offset={`${fill * 100}%`} stopColor="#D9D0C4" />
              </linearGradient>
            </defs>
            <path
              fill={`url(#star-${i}-${size})`}
              d="M10 1.6l2.47 5.2 5.53.78-4 3.99.95 5.63L10 14.5l-4.95 2.7.95-5.63-4-3.99 5.53-.78z"
            />
          </svg>
        );
      })}
